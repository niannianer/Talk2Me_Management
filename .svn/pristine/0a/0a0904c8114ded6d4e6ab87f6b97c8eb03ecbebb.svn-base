<template>
    <div class="merchant-list" flex="dir:top">
        ...
        <div flex-box="1">
            <span style="color: red">双击商家修改审核状态</span>
            <el-table :data="lists" border stripe 
                ...
                <el-table-column prop="submitTime" :formatter="formatTime" label="认领时间" align="center" sortable></el-table-column>
                <el-table-column prop="identifyTime" :formatter="formatTime" label="审核时间" align="center" sortable></el-table-column>
