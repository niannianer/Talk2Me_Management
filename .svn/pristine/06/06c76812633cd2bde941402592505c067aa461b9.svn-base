    ...
    <div class="check-message">
        ...
        <div flex-box="1">
            <el-table :data="lists" border stripe
                ...
                <el-table-column prop="submitTime" :formatter="formatTime" label="提交时间" align="center" width="98" sortable></el-table-column>
                <el-table-column prop="verifyTime" :formatter="formatTime" label="审核时间" align="center" width="98" sortable></el-table-column>
                <el-table-column prop="sendTime" :formatter="formatTime" label="发布时间" align="center" width="98" sortable></el-table-column>
...
<script>
    ...
    import '../less/check-message.less';
    export default {
        name: 'check-message',
        data(){
            return {
