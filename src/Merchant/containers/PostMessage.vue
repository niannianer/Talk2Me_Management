    ...
    <div class="post-message">
        ...
        <div class="my-table">
            <el-table
                ...
                <el-table-column prop="submitTime" label="日期" :formatter="formatTime" width="150"></el-table-column>
                <el-table-column prop="verifyFlag" label="审核状态" :formatter="statusText" width="100"></el-table-column>
            </el-table>
        </div>
        <nav-title title="信息编辑"></nav-title>
        <div class="content">
            <textarea class="text-box" placeholder="有什么信息想告诉大家？" v-model="writeText"></textarea>
            <div flex="dir:right" class="btn">
            <span class="my-btn">
                 <el-button type="primary" size="small" @click="sendMessage">发布</el-button>
            </span>
...
<script>
    ...
    export default {
        ...
        computed:{
            ...mapState(['claimedMId','isClaimed','unionid'])
        },
        components:{
            NavTitle
        },
